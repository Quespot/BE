...
@Component
public class MissionRecommendationCursorCodec {
    ...
    public MissionRecommendationCursorCodec(@Value("${app.jwt.secret}") String secret) {
        this.secretKey = new SecretKeySpec(secret.getBytes(StandardCharsets.UTF_8), HMAC_ALGORITHM);
    }

    public String encode(MissionRecommendationCursor cursor) {
    ...
    public MissionRecommendationCursor decode(String value) {
        try {
            ...
            MissionRecommendationCursor cursor = new MissionRecommendationCursor(
                    MissionRecommendationCursor.SortMode.valueOf(parts[0]),
    ...
    private void validate(MissionRecommendationCursor cursor) {
